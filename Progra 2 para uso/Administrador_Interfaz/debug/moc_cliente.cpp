...
#include "../../Cliente_Interfaz/cliente.h"
...
QT_MOC_LITERAL(5, 42, 16), // "escribirServidor"
QT_MOC_LITERAL(6, 59, 4), // "info"
QT_MOC_LITERAL(7, 64, 15), // "cambiarRegistro"
QT_MOC_LITERAL(8, 80, 6), // "string"
QT_MOC_LITERAL(9, 87, 16), // "verificarBloqueo"
QT_MOC_LITERAL(10, 104, 4) // "vali"

    },
    "Cliente\0connected\0\0disconnected\0"
    "readyRead\0escribirServidor\0info\0"
    "cambiarRegistro\0string\0verificarBloqueo\0"
    "vali"
};
...
void Cliente::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 4: _t->cambiarRegistro((*reinterpret_cast< string(*)>(_a[1]))); break;
        case 5: _t->verificarBloqueo((*reinterpret_cast< string(*)>(_a[1]))); break;
        default: ;
        }
    }
}
